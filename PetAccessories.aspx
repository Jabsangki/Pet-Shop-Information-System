<%@ Page Title="Products" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="PetAccessories.aspx.cs" Inherits="_Default" %>

<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
</asp:Content>
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        <center>
<div id="ScrAccessories">
        <br />
        <table>
        <tr>
        <td>
            <asp:Menu ID="Menu1" runat="server" BackColor="#FFFBD6" 
                ...
                ForeColor="#990000" Orientation="Horizontal" StaticSubMenuIndent="15px">
    ...
    ConnectionString="<%$ ConnectionStrings:db_a3539d_arkvetConnectionString %>" 
        ...
        SelectCommand="SELECT * FROM products WHERE ProductPurpose='Accessories'"></asp:SqlDataSource>
